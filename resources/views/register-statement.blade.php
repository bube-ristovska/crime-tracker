    ...
    <main class="w-full flex-grow p-6">
        ...
        <div class="w-full mt-12">
            <p class="text-xl pb-3 flex items-center">
                <i class="fas fa-list mr-3"></i> Додавање на изјава за случај со контролен број {{ session('c_id') }}
            </p>

            <div class=".center">
                <form method="POST" action="/register-statement" class="mt-10 .center">
                    @csrf
                    <div class="mb-6">
                    ...
                    <label for="witness">Сведок</label>
                    <input type="radio" id="witness" name="role" value="witness">

                    <label for="victim">Жртва</label>
